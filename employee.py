...
class employeeClass:
    def __init__(self, root):
        ...
        txt_cnic=Entry(self.root,textvariable=self.var_cnic,font=("goudy old style",15),bg="lightyellow").place(x=150,y=230,width=180)
        ...
        self.EmployeeTable=ttk.Treeview(emp_frame,columns=("eid","name","cnic","gender","contact","dob","doj","pass","utype","address","salary"),yscrollcommand=scrolly.set,xscrollcommand=scrollx)
        ...
        self.EmployeeTable.column("cnic",width=100)
        ...
        try:
            if self.var_emp_id.get()=="":
                ...
                if row!=None:
                    ...
                    cur.execute("Insert into Employee (eid,name,cnic,gender,contact,dob,doj,pass,utype,address,salary) values(?,?,?,?,?,?,?,?,?,?,?)",(
                                    self.var_emp_id.get(),
                                    self.var_name.get(),
                                    self.var_cnic.get(),
                                    self.var_gender.get(),
